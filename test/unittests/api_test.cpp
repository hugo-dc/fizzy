...
TEST(api, find_exported_global)
{
    ...
    const auto wasm_reexported_global = from_hex(
        "0061736d01000000010401600000020c010474657374026732037f000302010004040170000005030100000716"
        "04026731030003746162010001660000036d656d02000a05010300010b");
    ...
    EXPECT_FALSE(find_exported_global(instance_reexported_global, "g2").has_value());
